...
class CircleButton(Button, ABC):
    ...
    def _set_geom(self):
        ...
        logging.info("Set geom for %s using outline_frac %s, _rad %s" %
                     (self.name, self._outline_frac, self._outline_rad))
...
class ArtistButton(CircleButton):
    """
